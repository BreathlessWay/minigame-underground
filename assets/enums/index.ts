...
export enum TILE_TYPE_ENUM {
	WALL_ROW = "WALL_ROW", // 横向墙壁
	WALL_COLUMN = "WALL_COLUMN", // 竖向墙壁
	WALL_LEFT_TOP = "WALL_LEFT_TOP", // 左上
	WALL_RIGHT_TOP = "WALL_RIGHT_TOP", // 右上
	WALL_LEFT_BOTTOM = "WALL_LEFT_BOTTOM", // 左下
	WALL_RIGHT_BOTTOM = "WALL_RIGHT_BOTTOM", // 右下
	CLIFF_LEFT = "CLIFF_ROW_START", // 左围墙
	CLIFF_CENTER = "CLIFF_ROW_CENTER", // 中围墙
	CLIFF_RIGHT = "CLIFF_ROW_END", // 右围墙
	FLOOR = "FLOOR", // 地板
}
